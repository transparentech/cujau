...
//    public static void openSimple( String urlOrPath ) {
//        String osName = System.getProperty( "os.name" );
//        try {
//            if ( osName.startsWith( "Mac OS" ) ) {
//                // Class<?> fileMgr = Class.forName( "com.apple.eio.FileManager" );
...
//                // } );
//                // openURL.invoke( null, new Object[] { url } );
//                Runtime.getRuntime().exec( "open " + urlOrPath );
//            } else if ( osName.startsWith( "Windows" ) ) {
//                Runtime.getRuntime().exec( "rundll32 url.dll,FileProtocolHandler " + urlOrPath );
//            } else { // assume Unix or Linux
...
//                // Runtime.getRuntime().exec( new String[] { browser, url } );
//                // }
//                Runtime.getRuntime().exec( "xdg-open " + urlOrPath );
//            }
//        } catch ( Exception e ) {
//            throw new IllegalStateException( "Unable to open URL or Path: " + urlOrPath );
//        }
//    }
