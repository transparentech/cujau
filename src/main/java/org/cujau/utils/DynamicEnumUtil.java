...
/**
 * Uses reflection to add enums at runtime.
 *
...
public class DynamicEnumUtil {
    ...
    public static <T extends Enum<?>> void addEnum(Class<T> enumType, String enumName, Class<?>[] ctrArgTypes,
                                                   Object[] ctrArgs) {
        // 0. Sanity checks
        ...
        try {
            ...
            T newValue = (T) makeEnum(enumType, // The target enum class
                                      ...
                                      values.size(), //
                                      ctrArgTypes, // could be used to pass values to the enum constuctor if needed
                                      ctrArgs); // could be used to pass values to the enum constuctor if needed
